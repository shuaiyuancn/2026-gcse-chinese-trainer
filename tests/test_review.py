...
from main import app, create_question, create_user, create_practice_session, submit_answer
...
def test_review_routes():
    ...
    q = create_question(title="Review Q", image_url="/img.jpg", question_1="Q1", question_2="Q2", question_3="Q3", question_4="Q4", question_5="Q5", topic="T1")
